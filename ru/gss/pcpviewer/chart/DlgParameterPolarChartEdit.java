...
public class DlgParameterPolarChartEdit extends DlgDirEdit < JFreeChart > {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ru.gss.pcpviewer.PCPViewerApp.class).getContext().getResourceMap(DlgParameterPolarChartEdit.class);
        setTitle(resourceMap.getString("Form.title")); // NOI18N
        setModal(true);
        setName("Form"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ru.gss.pcpviewer.PCPViewerApp.class).getContext().getActionMap(DlgParameterPolarChartEdit.class, this);
